const theme = {
    ...
    lightgreen:     { value: "#00C7BE", text: "white" },
    ...
    transparent:    { value: "transparent", text: "transparent" },
...
const Colors = {
    ...
    getColor(mods) {
        return  mods.filter(mod => array.includes(mod.toLowerCase()))[0];
    }
};
